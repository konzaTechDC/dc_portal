# Generated by Django 4.0.5 on 2022-06-15 10:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('services', '0005_levelone_toplevel_leveltwo_levelthree_levelone_level'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='service',
            name='service_name',
            field=models.IntegerField(choices=[(1, 'Cloud Services'), (2, 'Webhosting Services'), (3, 'Collocation')], default=(1, 'Cloud Services'), unique=True),
        ),
        migrations.AlterField(
            model_name='webhostinghardwareresource',
            name='bandwidth',
            field=models.CharField(choices=[('Unlimited Bandwidth', 'Unlimited Bandwidth'), ('Unlimited Bandwidth', 'Unlimited Bandwidth'), ('Unlimited Bandwidth', 'Unlimited Bandwidth'), ('300GB Bandwidth', '300GB Bandwidth'), ('400GB Bandwidth', '400GB Bandwidth'), ('500GB Bandwidth', '500GB Bandwidth'), ('600GB Bandwidth', '600GB Bandwidth'), ('700GB Bandwidth', '700GB Bandwidth'), ('30TB Bandwidth', '30TB Bandwidth')], default=('Unlimited Bandwidth', 'Unlimited Bandwidth'), max_length=50),
        ),
        migrations.CreateModel(
            name='ServiceType',
            fields=[
